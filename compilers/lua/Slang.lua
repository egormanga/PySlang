...
int = setmetatable({
	...
	__cdiv = function(a, b) return int(math.ceil((getmetatable(a) == int and a[1] or a) / (getmetatable(b) == int and b[1] or b))) end,
	__rdiv = function(a, b) return int(math.floor((getmetatable(a) == int and a[1] or a) / (getmetatable(b) == int and b[1] or b) + .5)) end,
...
float = setmetatable({
	...
	__cdiv = function(a, b) return int(math.ceil((getmetatable(a) == float and a[1] or a) / (getmetatable(b) == float and b[1] or b))) end,
	__rdiv = function(a, b) return int(math.floor(((getmetatable(a) == float and a[1] or a) / (getmetatable(b) == float and b[1] or b)) + .5)) end,
