...
int = setmetatable({
	...
	__div = function(a, b) local r = ((getmetatable(a) == int and float(a[1]) or a) / (getmetatable(b) == int and float(b[1]) or b)); if r == 1/0 then return 1//0 else return r end end,
...
float = setmetatable({
	...
	__div = function(a, b) local r = ((getmetatable(a) == float and a[1] or a) / (getmetatable(b) == float and b[1] or b)); if r == 1/0 then return 1//0 else return float(r) end end,
